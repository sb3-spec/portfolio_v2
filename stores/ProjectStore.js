...
export const ProjectStore = writable([
  {
    ...
    img: [
      "./images/portfolio-projects/carbon_platform/the_carbon_platform_1.jpg",
      "./images/portfolio-projects/carbon_platform/the_carbon_platform_2.jpg",
    ],
    description:
      "I'm the lead fullstack software engineer and am responsible for the \
    ...
    keyInfo: {
      Hurdles:
        "The biggest issue that I faced was slow server response times. The culprit was a combination of inefficent SQL queries \
    ...
    tech: ["Svelte", "Django", "AWS", "Algolia", "Postgres"],
    liveLink: "",
    githubLinks: {
  ...
  },
  {
    title: "Parsley",
    img: [
      "./images/portfolio-projects/parsley/login.jpg",
      "./images/portfolio-projects/parsley/dashboard.jpg",
      "./images/portfolio-projects/parsley/recipe_1.jpg",
      "./images/portfolio-projects/parsley/new-recipe.jpg",
      "./images/portfolio-projects/parsley/edit-recipe.jpg",
    ],
    description:
      "This is a full-stack web application I made to help keep track of the different recipes I use. \
            ...
            to hold all the recipes you need in a centralized location, while also allowing users to grab recipe data right from an article. \
    ...
    features: [
      "Scrape recipes from recipe blogs",
  ...
  //   },
  {
    ...
    description:
      "This is the second iteration of the tutoring portal I made \
        to track the classes I have and the amount that my clients owe per month.",
    keyInfo: {
      Hurdles:
        "At the start, the most difficult aspect was setting up the api routing to make \
...

  {
    ...
    description:
      "The first iteration of my custom logging software uses Next.js for both the back and front, \
            with Redis as the database. It is used to track the classes I have and the amount that my clients owe for the month.",
    keyInfo: {
      Hurdles:
        "One of the challenges I faced early in development \
            was efficiently grabbing data from the server without making repetitive \
            calls.",
      Solutions:
        "My solution was making calls to the server at a central location near the root of my folder-- \
...

  {
    title: "Twitter Clone",
    img: [
      "./images/portfolio-projects/twitter_clone/twitter_clone_home.jpg",
      "./images/portfolio-projects/twitter_clone/twitter_clone_profile.jpg",
    ],
    description: "Twitter clone i built.",
    keyInfo: {
      Hurdles:
        "I was confused on how to handle the user's authentication state \
            to allow for automatic authentication for a period of time after the user signs in.",
      Solutions:
        "To solve the problem, I leveraged Auth0's refresh web tokens to make auth requests if they were still valid.",
    },
    features: [
      "Custom tweet feed",
    ...
    tech: ["React", "Django REST Framework", "Postgres"],
    liveLink: "",
    githubLinks: {
